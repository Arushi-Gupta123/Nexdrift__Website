  ...
  return (
    <section id='team' ref={container}>
      <div className="container">
        <h1 className="title">Our <span className="g-text">Leadership Team</span></h1>
        <h3 className="sub__title">
            Meet my diverse team of creative minds, developers, and startegists - the driving frce behind every project's success.
        </h3>
